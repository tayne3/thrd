...
if(CMAKE_USE_PTHREADS_INIT)
  target_link_libraries(thrd_compile_dependency INTERFACE ${CMAKE_THREAD_LIBS_INIT})
  return()
endif()
...
if(CMAKE_HAVE_PTHREADS_CREATE)
  target_link_libraries(thrd_compile_dependency INTERFACE "-lpthreads")
  return()
endif()
check_library_exists(pthread pthread_create "" CMAKE_HAVE_PTHREAD_CREATE)
if(CMAKE_HAVE_PTHREAD_CREATE)
  target_link_libraries(thrd_compile_dependency INTERFACE "-lpthread")
  return()
endif()
